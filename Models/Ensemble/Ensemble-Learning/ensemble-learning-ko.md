...
Rev. 6 | Created: 2026-09-10 | Updated: 2026-09-23 11:08 CDT

- [1. Purpose](#1-purpose)
- [2. Summary](#2-summary)
- [3. Taxonomy](#3-taxonomy)
  - [3.1 Three Axes](#31-three-axes)
  - [3.2 Hierarchy Of Combination Rules](#32-hierarchy-of-combination-rules)
  - [3.3 What A Member Supplies](#33-what-a-member-supplies)
  - [3.4 What The Combination Emits](#34-what-the-combination-emits)
- [4. Principle](#4-principle)
  - [4.1 Why Combining Helps](#41-why-combining-helps)
  - [4.2 The Correlation Floor](#42-the-correlation-floor)
  - [4.3 Disagreement](#43-disagreement)
- [5. Fixed Rules](#5-fixed-rules)
  - [5.1 Voting](#51-voting)
  - [5.2 Averaging](#52-averaging)
  - [5.3 Log-Odds And Rank](#53-log-odds-and-rank)
- [6. Fitted Weights](#6-fitted-weights)
  - [6.1 One Scalar Per Member](#61-one-scalar-per-member)
  - [6.2 Calibration](#62-calibration)
  - [6.3 Per-Row Confidence Weighting](#63-per-row-confidence-weighting)
- [7. Fitted Combiners](#7-fitted-combiners)
  - [7.1 Stacking](#71-stacking)
  - [7.2 Blending](#72-blending)
- [8. Frameworks](#8-frameworks)
  - [8.1 Bagging](#81-bagging)
...
- [Appendix B. Worked Example](#appendix-b-worked-example)
  - [B.1 Data And Members](#b1-data-and-members)
  - [B.2 Hard And Soft Voting](#b2-hard-and-soft-voting)
  - [B.3 Averaging Log-Odds](#b3-averaging-log-odds)
  - [B.4 Weighted Averaging With Out-Of-Fold Weights](#b4-weighted-averaging-with-out-of-fold-weights)
  - [B.5 Member Spread As An Uncertainty Signal](#b5-member-spread-as-an-uncertainty-signal)
- [Appendix C. Stacking And Blending](#appendix-c-stacking-and-blending)
  - [C.1 Stacking On Probabilities Against Labels](#c1-stacking-on-probabilities-against-labels)
  - [C.2 Blending](#c2-blending)
- [Appendix D. Confidence](#appendix-d-confidence)
  - [D.1 Calibration Before Averaging](#d1-calibration-before-averaging)
  - [D.2 Per-Row Confidence Weighting](#d2-per-row-confidence-weighting)
  - [D.3 Abstention](#d3-abstention)
- [Appendix E. Frameworks](#appendix-e-frameworks)
