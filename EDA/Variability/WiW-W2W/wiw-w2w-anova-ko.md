...
Rev. 124 | Created: 2026-09-01 | Updated: 2026-09-23 11:08 CDT
...
식 (2) 는 총평균에서 잰 편차를 두 조각으로 갈라 적는 데에서 나온다. 한 조각은 member 값이 제 group 평균에서 벗어난 양이고, 다른 조각은 그 group 평균이 총평균에서 벗어난 양이다.
