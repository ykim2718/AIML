# Outlier Detection
Rev. 5 | Created: 2026-08-17 | Updated: 2026-09-09 15:32 CDT
...
[outlier-detection.md](outlier-detection.md) surveys the field before any of that. It names the statistical, machine learning and deep learning families, records what a semiconductor line runs as part average testing and fault detection, and selects among them by what each one assumes. The documents below take the tests it summarizes and work them out. A Korean edition of the survey sits beside it as [outlier-detection-ko.md](outlier-detection-ko.md).
