...
4. If the data is a waveform or a trace, follow the parameterization document to reduce it to fixed-width feature rows. Where that waveform rests on a ladder of discrete levels rather than varying continuously, take the quantized-signal document instead.
