...
Rev. 53 | Created: 2026-08-07 | Updated: 2026-08-12 10:42 CDT
...
|-------|-----------|----------------|----------|
| `scalar` | Cell 하나가 값 하나를 담는다 (tabular data) | `[wafer, feature]` | 0 |
| `vector` | Cell 하나가 배열을 담고, 원소가 시간축이 아닌 축을 따라 놓인다 | `[wafer, feature, site]` | 1 |
| `matrix` | Cell 하나가 두 축을 갖는 배열을 담고, 두 축 모두 시간축이 아니다 | `[wafer, feature, die_x, die_y]` | 2 |
| `trace` | Cell 하나가 배열을 담고, 원소가 시간 순서로 정렬되어 있다 | `[wafer, feature, trace]` | 1 |
