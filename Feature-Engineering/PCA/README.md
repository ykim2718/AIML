...
1. If it is not yet clear which assumption broke, start from the summary table of the classical lineage document.
2. If the data is already understood, start from the selection table of the applications document and walk back up to only the branches it points at.
3. If learned representations are involved, or a neural model is to be combined with the reduction, read the modern lineage document.
