...
Rev. 4 | Created: 2026-09-04 | Updated: 2026-09-04 23:43 CDT
...
|---|---|---|
| [R2-SStot/variance-components.md](R2-SStot/variance-components.md) | English | It partitions the total variation into the explained and the residual part, then shows what each one does to the ratio: raising the residual variance drives R² down, and widening the predictor variance drives it up with the relationship unchanged. It closes by sweeping the coefficient of variation of a sample on the 1-to-1 line, which shows the same dependence from the data side. |
