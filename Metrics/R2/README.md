...
Rev. 7 | Created: 2026-09-04 | Updated: 2026-09-04 23:59 CDT
...
| [Regression-Metrics/regression-metrics.md](Regression-Metrics/regression-metrics.md) | English | It places R² in a taxonomy of regression metrics divided into mean-based, variance-based and agreement-based families, reads each against the $y=x$ line, and sets out the low variance effect that makes the variance-based family collapse on a nearly constant signal. |
