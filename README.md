# AIML
Rev. 84 | Created: 2026-08-07 | Updated: 2026-09-20 12:40 CDT
...
| [Agile](Agile/) | It covers the way the work around the model is run rather than the model itself — the three layers of agile practice, the sprint cycle and the vocabulary a team says its status in under `Agile-Software-Development/`, and what changes when the deliverable is a model rather than a feature under `Agile-AIML-Development/`. |
