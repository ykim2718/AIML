# AIML
Rev. 62 | Created: 2026-08-07 | Updated: 2026-09-10 21:05 UTC
...
| [Feature-Engineering/Feature-Selection/trace-feature-selection.md](Feature-Engineering/Feature-Selection/trace-feature-selection.md) | It verifies the filter-wrapper-embedded taxonomy against the feature list a semiconductor equipment trace produces — keeping the axis, moving the attribution and attention leaves out of the embedded branch, splitting tree importance and the filter branch, and lifting variance thresholding out into preprocessing — then adds the two axes the mechanism axis leaves undecided, the unit a selection is made at and whether it survives a change of wafers, and closes on a question-to-branch guide and the failure modes the branches share. |
