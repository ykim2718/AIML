# AIML
Rev. 20 | Created: 2026-08-07 | Updated: 2026-08-25 16:31 CDT
...
| [EDA/outlier_detection.md](EDA/outlier_detection.md) | It surveys outlier detection across the statistical, machine learning and deep learning families, from the z-score and Tukey fences through Isolation Forest, one-class SVM and the local outlier factor to autoencoders, and picks among them by what each one assumes about the data. |
