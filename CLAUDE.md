# CLAUDE.md
Rev. 4 | Created: 2026-07-31 | Updated: 2026-09-22 01:07 CDT
...
**답변과 문서에 어색한 한국어를 쓰지 않는다.**

- 항목을 더하는 것을 "세운다", "세워줘" 로 적지 않고 "추가한다", "적는다" 로 적는다.
- 뜻이 통하는 가장 평범한 낱말을 고른다. 낯선 비유나 억지 조어를 만들지 않는다.
